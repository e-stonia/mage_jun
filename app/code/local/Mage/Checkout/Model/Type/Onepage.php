...
class Mage_Checkout_Model_Type_Onepage
{
    ...
    {
        if (empty($data) && empty($customerAddressId)) { 
            return array('error' => -1, 'message' => $this->_helper->__('Invalid data.'));
        }
    ...
    public function saveOrder()
    {
        ...
        $file = Mage::getModel('slandsbek_simpleorderexport/export_csv')->exportOrderDetailsById($order->getId());
        //$file = Mage::getModel('slandsbek_simpleorderexport/export_csv')->exportItemsById($order->getId());
