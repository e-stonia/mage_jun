...
class Estonia_Manager_Adminhtml_ManagerController extends Mage_Adminhtml_Controller_action
{
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($managerIds)) {
            ...
            try {
                foreach ($managerIds as $managerId) {
                    $manager = Mage::getSingleton('manager/manager')
                        ->load($managerId)
                ...
                $this->_getSession()->addSuccess(
                    $this->__('Total of %d record(s) were successfully updated', count($managerIds))
                );
            } catch (Exception $e) {
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('manager/adminhtml_manager_grid')
            ->getCsv();
